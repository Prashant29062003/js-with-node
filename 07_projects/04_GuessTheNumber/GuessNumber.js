...
//         e.preventDefault();
//         const guessedValue = parseInt(userInput.value);
...
//     } else if (guess < 1) {
//         alert("Please Enter Valid Number greater than 1");
//     } else if (guess > 100) {
...
//     if (guess === randomNum) {
//         displayGuess(`You Won The Game, Congratulations guessed right!`)
//     } else if (guess < randomNum) {
//         displayGuess(`Your guess is TOO LOW`);
//     } else if (guess > randomNum) {
//         displayGuess(`Your guess is TOO HIGH`);
//     }
// }
